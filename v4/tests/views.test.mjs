...
assert.match(elements.get('page-projects').innerHTML,/배당 상세 보기/);
...
assert.match(elements.get('page-settings').innerHTML,/DividendOS 0\.9\.7/);
...
console.log('DividendOS v0.9.7 view QA: PASS');
