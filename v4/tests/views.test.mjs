...
assert.match(elements.get('page-home').innerHTML,/② 올해 배당/);
...
assert.match(elements.get('page-settings').innerHTML,/DividendOS 0\.9\.6/);
...
console.log('DividendOS v0.9.6 view QA: PASS');
