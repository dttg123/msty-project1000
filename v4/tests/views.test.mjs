...
assert.match(elements.get('page-home').innerHTML,/data-home-year-range="5"/);
...
assert.match(elements.get('page-settings').innerHTML,/DividendOS 0\.11\.3/);
...
console.log('DividendOS v0.11.3 view QA: PASS');
