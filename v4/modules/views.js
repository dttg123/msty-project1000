import { selectRecords, monthWeeks } from './activity.js';
import { APP_VERSION } from '../backup.js';
import { frequencyOf } from './income.js';
import { clamp, esc, isDate, n, todayISO } from './utils.js';
import { buildHomeMetrics, nextMilestone } from './home-metrics.js?v=0.10.0-r38';

export function createViews(context) {
  const {
    getState, getSelectedProjectId, setSelectedProjectId, getChartMode, getHistoryLimit, getHistoryFilter, getChartMonth, getCashflowMonthKey, getHomeBreakdownExpanded, getPortfolioCategory, setPortfolioCategory, getCurrentUser, isTossBridgeConfigured,
