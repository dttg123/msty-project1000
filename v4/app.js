...
import { openStorage, storageGet, storageSet, storageDelete, readLegacyState } from './storage.js?v=0.9.4-r20';
...
import { createViews } from './modules/views.js?v=0.9.4-r20';
...
import { clearTossLocalConfig, fetchCurrentPublicIp, fetchTossSnapshot, getTossConnectionMode, getTossLocalConfig, getTossSettingsUrl, isTossBridgeConfigured, saveTossLocalConfig, testTossDirectConnection } from './toss-client.js?v=0.9.4-r20';
...
(() => {
  ...
  async function init() {
    try{
      ...
      if('serviceWorker'in navigator&&location.protocol.startsWith('http'))navigator.serviceWorker.register('./sw.js?v=0.9.4-r20').catch(console.warn);
