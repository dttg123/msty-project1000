...
import { openStorage, storageGet, storageSet, storageDelete, readLegacyState } from './storage.js?v=0.9.1-r15';
...
import { fetchTossSnapshot, isTossBridgeConfigured } from './toss-client.js?v=0.9.1-r15';
...
(() => {
  ...
  async function init() {
    try{
      ...
      if('serviceWorker'in navigator&&location.protocol.startsWith('http'))navigator.serviceWorker.register('./sw.js?v=0.9.1-r15').catch(console.warn);
