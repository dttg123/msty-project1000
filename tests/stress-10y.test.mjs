...
assert.match(elements.get('page-home').innerHTML,/종목별·날짜별 내역/);
...
console.log(`DividendOS v0.11.1 10-year stress QA: PASS (${restored.trades.length} trades, ${restored.dividends.length} dividends)`);
