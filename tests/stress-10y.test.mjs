...
const views=createViews({
  ...
  getChartMode:()=> 'month',getCashflowMonthKey:()=> '',getHomeBreakdownExpanded:()=> true,getPortfolioCategory:()=> 'highYield',setPortfolioCategory:()=>{},
...
assert.match(elements.get('page-home').innerHTML,/이번 달 종목별 배당/);
...
console.log(`DividendOS v0.9.10 10-year stress QA: PASS (${restored.trades.length} trades, ${restored.dividends.length} dividends)`);
