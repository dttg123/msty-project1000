...
assert.match(elements.get('page-home').innerHTML,/최근 12개월 실제/);
...
assert.match(elements.get('page-settings').innerHTML,/DividendOS 0\.9\.10/);
...
console.log('DividendOS v0.9.10 view QA: PASS');
