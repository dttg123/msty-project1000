...
assert.match(elements.get('page-home').innerHTML,/현재 보유량 월 환산/);
...
assert.match(elements.get('page-settings').innerHTML,/DividendOS 0\.10\.0/);
...
console.log('DividendOS v0.10.0 view QA: PASS');
