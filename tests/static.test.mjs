...
assert.ok(index.includes('<link rel="stylesheet" href="./styles.css?v=0.9.1-r15" />'));
assert.ok(index.includes('<script type="module" src="./app.js?v=0.9.1-r15"></script>'));
...
assert.ok(sw.includes("dividend-os-v0.9.1-r15"));
...
assert.ok(index.includes('app.js?v=0.9.1-r15'));
...
assert.ok(app.includes("storage.js?v=0.9.1-r15"));
...
assert.ok(app.includes("toss-client.js?v=0.9.1-r15"));
