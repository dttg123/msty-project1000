...
assert.ok(index.includes('<link rel="stylesheet" href="./styles.css?v=0.9-r4" />'));
assert.ok(index.includes('<script type="module" src="./app.js?v=0.9-r4"></script>'));
...
assert.ok(index.includes('app.js?v=0.9-r4'));
