...
import { buildHomeMetrics, nextMilestone } from './home-metrics.js?v=0.10.0-r36';
    ...
    page.innerHTML=`
      ...
      <div class="stack portfolio-stack">
        ...
        <article class="card portfolio-cashflow">
          ...
          <div class="detail-note">${!calc.estimateReliable?'보유주수와 최근 배당 기록이 있어야 예상할 수 있습니다.':calc.income?.known?'현재 보유량 × 최근 주당 세후배당':'지급 기준 주수가 없어 과거 실입금 평균 사용'}</div><div class="entry-actions"><button class="btn primary" data-add-trade>거래</button><button class="btn secondary" data-add-dividend>배당금 입금</button></div>
        </article>
